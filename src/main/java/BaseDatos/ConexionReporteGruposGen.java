...
package BaseDatos;
//clase para consultar grupos y articulos
//cuando se requiere existencias generales por año
//no se filtra la seccion de la sesion en la cual se esta trabajando
...
public class ConexionReporteGruposGen {
    Connection conex;
         ...
         try
    {
       ...
       /*  consulta=conex.prepareStatement(
        //select codigo from articulos where id_grupo=? and id_subgrupo=?"
        " select SUM(valor_entrada) as entradas, SUM(valor_salida) as salidas \n" +
        "from historiales \n" +
        "where \n" +
