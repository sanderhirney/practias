...
public class Crear_Servicio extends javax.swing.JDialog {
    ...
    private void boton_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarActionPerformed
        ...
        {
            ConexionCrearServicios servicio= new ConexionCrearServicios();
            servicio.setNombre(Campo_nombre.getText().trim().toUpperCase());
            servicio.crear();
            if(servicio.respuesta()==1)
            {
                JOptionPane.showMessageDialog(null, "Informacion Guardada Correctamente", "Informacion", JOptionPane.INFORMATION_MESSAGE);
                Campo_nombre.setText("");
                
            }
            if(servicio.respuesta()==0)
            {
                JOptionPane.showMessageDialog(null, "No se pudo guardar la informacion. Revise", "Informacion", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Crear_Servicio dialog = new Crear_Servicio(new javax.swing.JFrame(), true);
