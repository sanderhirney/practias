 ...
 * @author Usuario
 */
public class Consultar_Articulo extends javax.swing.JDialog {

    /**
     * Creates new form Consultar_Articulo
     */
    public Consultar_Articulo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultar_Articulo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Consultar_Articulo dialog = new Consultar_Articulo(new javax.swing.JFrame(), true);
